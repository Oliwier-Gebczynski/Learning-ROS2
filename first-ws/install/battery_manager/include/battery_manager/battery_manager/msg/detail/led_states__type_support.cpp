...
{
  new (message_memory) battery_manager::msg::LedStates(_init);
}

void LedStates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<battery_manager::msg::LedStates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LedStates_message_member_array[2] = {
  {
    ...
    offsetof(battery_manager::msg::LedStates, led_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(battery_manager::msg::LedStates, state),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LedStates_message_members = {
  "battery_manager::msg",  // message namespace
  "LedStates",  // message name
  2,  // number of fields
  sizeof(battery_manager::msg::LedStates),
...
{
  return &::battery_manager::msg::rosidl_typesupport_introspection_cpp::LedStates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, battery_manager, msg, LedStates)() {
  return &::battery_manager::msg::rosidl_typesupport_introspection_cpp::LedStates_message_type_support_handle;
}
