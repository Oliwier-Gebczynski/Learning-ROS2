...
#include "battery_manager/msg/detail/led_states__rosidl_typesupport_fastrtps_c.h"
...
using _LedStates__ros_msg_type = battery_manager__msg__LedStates;
...
size_t get_serialized_size_battery_manager__msg__LedStates(
  const void * untyped_ros_message,
...
static uint32_t _LedStates__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_battery_manager__msg__LedStates(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_battery_manager
size_t max_serialized_size_battery_manager__msg__LedStates(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = battery_manager__msg__LedStates;
    is_plain =
      (
...
static size_t _LedStates__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_battery_manager__msg__LedStates(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, battery_manager, msg, LedStates)() {
