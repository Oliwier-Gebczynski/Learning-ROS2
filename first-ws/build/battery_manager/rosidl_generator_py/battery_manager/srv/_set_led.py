...
class Metaclass_SetLed_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('battery_manager')
        except ImportError:
            import logging
            import traceback
...
class SetLed_Request(metaclass=Metaclass_SetLed_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.led_id = kwargs.get('led_id', int())
    ...
    def led_id(self, value):
        if __debug__:
            assert \
                ...
                "The 'led_id' field must be of type 'int'"
            assert value >= -9223372036854775808 and value < 9223372036854775808, \
                "The 'led_id' field must be an integer in [-9223372036854775808, 9223372036854775807]"
        self._led_id = value
...
class Metaclass_SetLed(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from battery_manager.srv import _set_led
...
class SetLed(metaclass=Metaclass_SetLed):
    from battery_manager.srv._set_led import SetLed_Request as Request
    from battery_manager.srv._set_led import SetLed_Response as Response
